...
HELP_STRING = f"★ 🇵ʀᴇᴍɪᴜᴍ ʙᴏᴛs ʜᴇʟᴘ ᴍᴇɴᴜ ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @Premium5119**"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• 𝐎𝐖𝐍𝐄𝐑💫 •", "https://t.me/l_Balaji_l"),
      Button.url("• 𝐒𝐔𝐏𝐏𝐎𝐑𝐓💖 •", "https://t.me/Sanatani_Dharam_op")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://telegra.ph/file/ac33448dfb4ea344f6a52.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("ᴘᴀʜʟᴇ 𝙿𝚁𝙴𝙼𝙸𝚄𝙼ㅤᯤ⁹⁹⁹⁺ ᴘᴀᴘᴀ sᴇ sᴜᴅᴏ ʟᴇʟᴏ 💀 @Premium5119", cache_time=0, alert=True)
...
async def help_raid(event):
    if event.query.user_id in SUDO_USERS:
        ...
        await event.answer("ᴘᴀʜʟᴇ 𝙿𝚁𝚁𝙼𝙸𝚄𝙼ㅤᯤ⁹⁹⁹⁺ ᴘᴀᴘᴀ sᴇ sᴜᴅᴏ ʟᴇʟᴏ 💀 @Premium5119", cache_time=0, alert=True)
